...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=True,
                 groups=1, width_per_group=64, outstride=32, norm_layer=None):
        ...
        self.layer1 = self._make_layer(block, 64, layers[0], stride=stride_list[0], dilation=dilation_list[0])
    ...
    def _make_layer(self, block, planes, blocks, stride=1, dilation=1):
        ...
        layers.append(block(self.inplanes, planes, stride, downsample, self.groups,
                            self.base_width, dilation=dilations[0], norm_layer=norm_layer))
        self.inplanes = planes * block.expansion
        for i in range(1, blocks):
            layers.append(block(self.inplanes, planes, groups=self.groups,
                                base_width=self.base_width, dilation=dilations[i],
